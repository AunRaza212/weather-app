...
const Cities = () => {
  ...
  return (
    <Stack direction="row">
      <Stack direction="column">
        <CitiesInfo city={"Karachi"} temperature={apiData['Karachi'].current.temp_c} time={apiData['Karachi'].location.localtime}/>
        <CitiesInfo city={"Lahore"} temperature={apiData['Lahore'].current.temp_c} time={apiData['Lahore'].location.localtime} />
        <CitiesInfo city={"Multan"} temperature={apiData['Multan'].current.temp_c}  time={apiData['Multan'].location.localtime}/>
        <CitiesInfo city={"Islamabad"} temperature={apiData['Islamabad'].current.temp_c} time={apiData['Islamabad'].location.localtime} />
      </Stack>
